                    ...
                    <div class="col-xl-6">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <canvas id="myAreaChart" width="479" height="191"
                                        style="display: block; width: 479px; height: 191px;"
                    ...
                    <div class="col-xl-6">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <canvas id="myBarChart" width="479" height="191" class="chartjs-render-monitor"
                                        style="display: block; width: 479px; height: 191px;"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
